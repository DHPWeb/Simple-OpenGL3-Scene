...
{
	// Initialisation du tableau de m_touches[]
...
void Input::updateEvenements()
{
	...
	{
		// Switch sur me type d'évènement

		switch (m_evenements.type)
		{
			// Cas d'une touche enfoncé
		...
		case SDL_KEYUP:
			...
			// Cas pression d'un bouton de la souris
...
void Input::capturePointeur(bool reponse) const
{
	if (reponse)
